...
import { pokemonRoute, pokemonSpeciesRoute, pokemonTabs} from "../utils/Constant";
...
function Pokemon() {
  ...
  const{currentPokemonTab} = useAppSelector(({app}) =>{return app});
  ...
  return <div>{currentPokemonTab === pokemonTabs.description && <Description />}
